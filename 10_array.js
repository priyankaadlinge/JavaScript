...
// Access the array element 90    y x22wq21
...
const sliceArr = arrayOfRollNumbers.slice(2, 3);
console.log(sliceArr);

console.log("Splice()");
var arrayOfRollNumbers = [67, 56, 78, 90, 60, 90, 40];
const arraySpliced = arrayOfRollNumbers.splice(3,3);
console.log(arrayOfRollNumbers);
...
for (const element in arrayNames) {
...
for (const index in arrayNames) {  //for in
   if (index%2==0) {
    console.log(`${arrayNames[index]}`);
   }
